...
<header>
  <nav>
    <?php
    $subMenu = ['Новости', 'Политика', 'Наука'];
    $menu = ['Главная', ['Новости' => $subMenu], 'О нас', 'Контакты'];

    foreach ($menu as $itemMenu) {
      echo '<div>';
      if (is_array($itemMenu)) {

        foreach ($itemMenu as $subName => $subItem) {
          echo "<a><span>$subName</span></a>";
          echo '<div>';
